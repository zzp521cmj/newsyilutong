...
<script type="text/javascript">
            ...
            grid = $("#dg").datagrid(
                    {
                        ...
                        onLoadSuccess : function() {
                            var carId = $(window.parent.document).find('#modifyId')
        ...
        var submitForm = function($dialog, $grid, $pjq, $mainMenu) {
            ...
            company.document.getElementById('phone').value = $("#tels").val();
	...
	<form action="shipOrder.do" id="outputform" method="post">
		<div region="north" title="车辆基础信息管理" class="st-north" border="false"
			...
			<div>
				...
				<lable>箱型:</lable>
				<input type="text" id="length_name" name="length_name" class="easyui-combobox">
				&nbsp;<a class="easyui-linkbutton" onclick="searchTruck()"
      ...
      <a class="easyui-linkbutton" id="tbgenzong" onclick="" data-options="plain:true"style="display: none">跟踪</a>-->
		...
		<input type="hidden" name="method" value="outShipOrder"> <input
			...
			id="tels" name="tels" /> <input type="hidden" id="driverid"
			name="driverid" />
	</form>
