...
<html>
  ...
  <script type="text/javascript">  
  	var pid='<%=pid%>';
  		$(function(){
		 $("#dg").datagrid({
			url : 'settleTC_fu.do?method=getSettleRc&order_id='+pid+'&settl_order='+'<%=settl_order%>',
  			border : false,
  			rownumbers : true,
  			fit : true,
  			singleSelect : false,
  			...
  			columns : [[
  				...
  				{field : 'allmoney',title : '应付金额',width : 80,align:'center'},
  				{field : 'settl_money',title : '实付金额',width : 80,align:'center'},
  ...
  <body class="easyui-layout">
   <form action="car_b_rec.do" id="outputform" method="post"> 	
    	<div region="center" >
    		<table id="dg" title="中转记录信息"></table>
    	</div>
