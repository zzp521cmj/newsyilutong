			...
			//双击事件
							...
							onLoadSuccess : function(data) {
								...
								$('#dg').datagrid('appendRow', {
									...
									picking_fee: compute("picking_fee"),
  	...
  	function putgouxuan(){
		...
		for(i=1;i<allRows2.length;i++)
		{
  		...
  		formout.submit();		
  			...
  			$.messager.alert("应付款导出","请选择要导出的信息","info");
  		}
  	}
...
<body class="easyui-layout">
	<form action="deal.do" id="outputform" method="post">
	...
	<form action="deal.do" id="formout" method="post">
