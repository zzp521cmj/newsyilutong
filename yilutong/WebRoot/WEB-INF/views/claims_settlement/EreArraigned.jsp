 	 ...
 	 //可提交
		$pjq.messager.confirm('运费结算','确定要提交吗?',function(r){   
	    	if (r){    
				$.ajax({
					type: "POST",
		  			url:'claims_settlement.do?method=updatedocuments',
		  			data:{
		  			claimsid:pid.join(","),
		  		
		  			did:$.trim($("#did").combotree("getValue")),
		  			arraign_remarks:$("#remarks").val()
		  			},/* $('#Editform').serialize() */
		  			success:function(msg){
		  				if(msg.flag){
		  					$pjq.messager.alert('运费结算','订单运费结算提审成功','info');
			    ...
			    $pjq.messager.alert('运费结算', '请选择提审部门', 'info');
			  }
	};
     	...
     	<table class="tableclass">
	    	...
	    	<tr>
			    ...
			    <td colspan="1" class="td2">
					<textarea class="easyui-textarea" cols="25" rows="2"  id="remarks" name="arraign_remarks"></textarea>
	        </tr>
		</table>
    </fieldset>
	</form>
