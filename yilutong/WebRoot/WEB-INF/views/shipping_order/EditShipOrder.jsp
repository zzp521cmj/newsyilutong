		...
		<fieldset>
			<table class="tableclasss">
				...
				<tr>
					...
					<td class="td3"><select id='send' class="combobox"
						name="send_type"
				...
				<tr>
					...
					<td colspan="2" class="td5"><input type="text" id=""
						name="send_shouji" class="validate[required]">
					</td>
				...
				<tr>
					<th colspan="14" class="td3"><b>收货人</b>
					</th>
				</tr>
				<tr>
					...
					<td colspan="2" class="td5"><input type="text" id=""
						name="receipt_phone" class="validate[required]"></td>
				...
				<tr>
					...
					<td class="td5"><input id="insurance_fee" type="text"
						class="validate[custom[number],max[99999.99],min[0.00],custom[dd]]"
						value="0.00" name="insurance_fee" readonly="readonly"
						onkeyup="value=value.replace(/[^\d\.]/g,'');SumNum();SumNum2();SumNum3();" />
					</td>
					<td class="td5"><input type="text"
						class="validate[custom[number],max[99999.99],min[0.00],custom[dd]] "
						value="0.00" name="trade_agency" id="trade_agency"
					...
					<td class="td5"><input type="text"
						class="validate[custom[number],max[99999.99],min[0.00],custom[dd]] "
						value="0.00" id="handling_charge" readonly="readonly"
						name="handling_charge" /></td>
					<td class="td5"><select id='type' class="combobox"
					...
					<td class="td5"><input type="text" value="0" id="is_recept"
						readonly="readonly" name="is_recept"></td>
				...
				<tr>
					...
					<td class="td5"><input placeholder="0.00"
						class="validate[custom[number],max[99999.99],min[0.00],custom[dd]]"
						type="text" id="transport_pay" readonly="readonly"
						name="transport_pay"
						onkeyup="value=value.replace(/[^\d\.]/g,'');SumNum2();" />
					...
					<td class="td" colspan="2"><input type="checkbox"
						name="printed" value="1" style="width:15px">机打运单
						&nbsp;&nbsp; <input type="checkbox" name="printed" value="0"
						style="width:15px">机打标签</td>
				</tr>
				<tr>
