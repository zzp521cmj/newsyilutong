  ...
  var pids=[];
 	pids.push(pid);
  	$(function(){
  		...
  		$.ajax({
  		  	url: 'settlementYf.do?method=getSettlout',
  		  	 data:{id:pids.join(",")},
  		  	success:function(data){
  		  		data.transport_pay=parseFloat(data.transport_pay)-parseFloat(data.settlyf_fu.split(",")[1]);
  		  		data.reality_sum=parseFloat(data.settlyf_fu.split(",")[0])-parseFloat(data.settlyf_fu.split(",")[1]); 	
  	...
  	<table class="tableclass">
		...
		<tr>
	 	<td><font color="red" style="margin-right:10px">*</font>运单号:</td>
			...
			<td><font color="red" style="margin-right:10px">*</font>应收运费:</td>
			<td class="td2">
				<input type="text" class="validate[required]" 	readonly="true" id="price" name="transport_pay" />
	      	</td>
	    </tr>
	    <tr>			
			<td><font color="red" style="margin-right:10px">*</font>实收运费:</td>
			<td class="td2">
				<input type="text" class="validate[required]" readonly="true" id="price1" name="reality_sum" />
	      	</td>
	      	<td>			
