...
<html>
  ...
  <script type="text/javascript">
 		...
 		var editval;
  		$(function(){
  			grid=$("#dg").datagrid({
  			url : 'Destination.do?method=getDestinationFeeCuctome',
  			border : false,
  			rownumbers : true,
  			fit : true,
  			singleSelect : false,
  ...
  /* 			rowStyler : function(index, row) {
			...
			onDblClickRow:function(rowIndex, rowData){
				...
				dialog = parent.jy.modalDialog({
					title : '运单查看',
				      url : 'Destination.do?method=getShippingCollect&pid='+pid,
						/* 				 buttons :'#addbuttons'
						*/
					fit : true,
					buttons : [{
...
/*   				{field : 'shipping_orde',title : '详细信息',width : 80,align:'center',sortable:'true',
  				...
  				{field : 'customer_num',title : '客户编码',width :80,align:'center'},
  				{field : 'customer_name',title : '客户名称',width :80,align:'center'},			
  				{field : 'customer_tel',title : '联系方式',width :80,align:'center'},
  				{field : 'customer_address',title : '地址',width :80,align:'center'},
  				...
  				{field : 'destination_fee',title : '总应收金额',width : 80,align:'center'},
  				
  				{field : 'paid_fee',title : '总实收金额',width : 80,align:'center'},
  				{field : 'reality_sum',title : '已收金额',width : 100,align : 'center'},
