...
/* 		    var mris = $('#received_remarks').val();
		    var kahao = $('#kahao').val();
		    var usernames = $('#usernames').val();
		    var khbank = $('#khbank').val();
		 
		    var radionum = document.getElementById("Regform").destination_stata;
			...
			if (r) {
				$.ajax({
					type : "POST",
					url : 'Destination.do?method=updateJieSuan&pid='+pid,
					data : {
 	     ...
 	     <table class="tableclass">
			...
			<tr>
				...
				<textarea class="easyui-textarea" id="remarks_fee1"
						cols="30" rows="2" name="remarks_fee1">
				</textarea>
			</td>
			</tr>			
			</table>
