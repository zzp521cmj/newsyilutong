...
<body>
	<div class="col-md-8 centered"
		style='background-color: #71CBAD;width: 385px;height: 240;margin-left: 6px;'>
		<div id="test1-container">
			<ul id="test1" style="padding-top: 5px;">
			</ul>
			<i class="fa fa-arrow-down" id="test1-next" style='position: absolute;margin-top: -40px;MARGIN-left: -70PX;'></i>
			<i class="fa fa-arrow-up" id="test1-prev" style='position: absolute;margin-top: -40px;MARGIN-left: 50PX;'></i>
		</div>
	</div>
...
<!-- 	<script src="assets/js/jquery-1.10.2.js"></script>
	...
	<script>
		...
		var nt_example1 = $('#test1').newsTicker({
			row_height : 80,
			max_rows : 3,
			duration : 4000,
			prevButton : $('#test1-prev'),
			nextButton : $('#test1-next')
		});
