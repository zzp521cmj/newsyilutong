...
$.extend($.fn.tabs.methods, {
    ...
    loadTabIframe:function(jq,params){
        return jq.each(function(){
            ...
            var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:20px;line-height:15px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px solid #d4d4d4;padding: 12px 5px 10px 30px;background: #ffffff url(\'../../truck_cloud/easyui/themes/default/images/loading.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || '页面加载中 ,稍等...') + '</div>').appendTo($tabBody);
