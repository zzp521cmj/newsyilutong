...
@Component
public class SettleDaiskServiceImpl implements SettleDaiskService {
	@Resource
	private SettleDaiskDao SettlementYfDao;
	//结算运费修改
	...
	public int getSettleShRcs(String start_date, String end_date, String ddids) {
		...
		public List<Settle_history> getupdateSettle(String table_name,
				Integer settl_order,String[] idss) {
			return SettlementYfDao.getupdateSettle(table_name, settl_order,idss);
		}
		public int updateSettle(List<Settle_history> list, String table_name,
				String settl_state) {
