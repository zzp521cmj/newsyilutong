...
<html>
  ...
  <body class="easyui-layout">
	...
	<input type="hidden"   name="adorn_fee1" >
 	<table class="tableclass">
			<tr>
					<td>			
					<font color="red" style="margin-right:10px">*</font>付款方式：</td>
					<td class="td2" colspan="3">	
					<input type="radio" name="write_off4" value="1"  style="width:14px" /><label style="margin-left: 10px">现金</label>
					<input type="radio"  name="write_off4" value="0"  style="width:14px" /><label  style="margin-left: 10px">刷卡</label>
					</td> 
				</tr>
				<tr>
				<td style="color: blue;">备注:</td>
				<td colspan="3" class="td2"><textarea class="easyui-textarea" id="loading_remarks"
						cols="40" rows="2" name="loading_remarks"></textarea></td>
			</tr>		
			</table>
		  </form>	
  </body>
