 	...
 	var submitForm = function($dialog, $grid, $pjq, $mainMenu) {
		...
		$pjq.messager.confirm('新增发布','确定要新增吗?',function(r){   
	    	...
	    	var dingdanid = $("#dingdanhao").val();   
				$.ajax({
					type: "POST",
		  			url:'temvehicle.do?method=addDemand_release',
   	...
   	<fieldset>
		<table class="tableclass">
				...
				<tr>
							...
							<td><font color="red" style="margin-right:10px">*</font>起始地:</td>
							<td class="td2"><input type="text" 
								class="validate[required]" id="num" name="start" >
							</td>
							<td><font color="red" style="margin-right:10px">*</font>到达地:</td>
							<td class="td2"><input type="text" 
								class="validate[required]" id="num" name="end" >
							</td>
							</tr>
		<tr>
