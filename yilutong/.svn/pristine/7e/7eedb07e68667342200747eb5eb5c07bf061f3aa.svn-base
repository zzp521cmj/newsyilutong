<%@page import="com.jy.model.TravelImg"%>
...
<%
	List<TravelImg> listOrderImg=null;
	if(!request.getAttribute("iurl").equals("")){
	listOrderImg = (List<TravelImg>) request.getAttribute("iurl");
	}
%>
<style type="text/css">
				...
				<div class="queueList" style="height:300px;">
					<div id="dndArea" class="placeholder">
						...
						<div >
							...
							<%
								for (TravelImg shipperOrderImg : listOrderImg) {
							%>
									<li><img class="imsty" src=<%=shipperOrderImg.getImage_url()%>>
									</li>
							<%
								}
							%>
