...
<body>
	<div class="col-md-7 centered"
		...
		<div id="test-container" style="height: 310px;">
			<ul id="test" style="margin-top: 10px;">
				
			</ul>
			<i class="fa fa-arrow-down" id="test-next" style='MARGIN-RIGHT: 55PX;    margin-top: 20;'></i>
			<i class="fa fa-arrow-up" id="test-prev" style='margin-top: 20;'></i>
		</div>
	</div>
...
<!-- 	<script src="assets/js/jquery-1.10.2.js"></script>
	...
	<script>
		...
		var nt_example1 = $('#test').newsTicker({
			row_height : 80,
			max_rows : 3,
			duration : 4000,
			prevButton : $('#test-prev'),
			nextButton : $('#test-next')
		});
