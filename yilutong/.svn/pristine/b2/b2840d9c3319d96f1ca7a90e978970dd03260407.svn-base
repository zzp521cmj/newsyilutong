...
public interface DestinationFeeCloseDao {
	/**
	 * 添加审核
	 * **/
	 ...
	 * 应收代收运审核
	 * */
	int UpdateCheckedShipp(String stata,@Param("array")String[] id);
	/**
	 * 应收代收运费客户导出
	 * */
     ...
     * 查询
     * */
    public List<DestinationFeeCloseMordel> getShippingJiLu(@Param("array")String [] sid); 
    /**
     * 查看详情
     * */
    public List<Settle_history> getXiangQingShipp(int rows, int page,String id);;
    public int getXiangQingShippCount(String pid,String jiesuantime,String jiesuantimes);
    
    /**
     * 订单导出
     * */
    public List<DestinationFeeCloseMordel> getCustomerInput(String pid,String send_time,String send_times,String jiesuStata,String shenhe,String jiesuantime,String jiesuantimes,String order_time,String order_times,String shipindi,@Param("array")String[] shioid,String idss );
	/**
	 * 应收代收运费客户审核运单查询
	 * */
