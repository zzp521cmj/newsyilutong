 ...
 *理赔结算审核
 */
public interface ClaimsExaminerDao {
	// 不合格申请总条数
		int count(String numbersid, String claims_state, String claims_time,String claims_endtime, String custom_name, String receipt,@Param("list") List<String> deptlist);
		...
		List<Claim_settlementmap> checkQuery(int rows, int page, String numbersid,
				...
				String receipt,@Param("list") List<String> deptlist);
		/*
		 * /查询发货的方法
		 */
		 ...
		 *  审核
		 */
		int review(String audit_opinion, @Param("array") String[] claimsid);
