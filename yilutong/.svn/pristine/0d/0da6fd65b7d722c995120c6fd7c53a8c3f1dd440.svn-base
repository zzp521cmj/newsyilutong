...
public interface SettlementTCDao {
	//结算运费修改
	...
	//结算运费审核历史记录查询
		...
		List<CreateAgreement> getCustomerSetYfout(String agreement_number,
				String agreement_type,String agreementstartdate,String agreementenddate ,String sort,String order,@Param("array") String[] idss);
