...
public interface HandlingChargeService {
	 ...
	 * 应收代收运费客户结算
	 * */
	public int updateJieSuan(@Param("array") String[] sid,
			String des_sige_name, String des_bank, String des_card,
			String des_time, String des_name, String des_market,
			String destination_stata);

	/**
	 * 应收代收运费客户提审
	 * */
	public int updateTiShen(@Param("array") String[] sid, String des_ts_bm,
			String des_ts_market);
	 ...
	 * 应收代收运审核
	 * */
	int UpdateCheckedBohui(String[] stata, String id);

	/**
	 * 修改审核记录表
	 * */
	int updateJyShenJiLU(String shenhe_name, String shenhe_stime,
	...
	public List<DestinationFeeCloseMordel> getCustomerInput(String pid,
			...
			String shenhe, String jiesuantime, String jiesuantimes,
			String order_time, String order_times, String shipindi,
			@Param("array") String[] shioid, String sid);
	 ...
	 * 订单修改导出
	 * */
	public List<jiLuLiShi> getXiuGaiJuInput(String num, String xiugaitime,
			String xiugaitimes, String[] jilu_id);
   /**
    * 审核界面查询
    * */
