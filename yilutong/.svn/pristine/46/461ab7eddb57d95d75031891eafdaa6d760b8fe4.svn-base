...
<html>
  ...
  <script type="text/javascript">
	...
	$("#tbput").removeAttr("style");
  			...
  			grid=$("#dg").datagrid({
  			url : 'monitor.do?method=getMonitorRuning&monitorType=3',
  			border : false,
  			rownumbers : true,
  			fit : true,
  			singleSelect : false,
  			...
  			columns : [[
  				...
  				{field : 'not_to_site',title : '未停留站点',width : 200,align:'center'},
    				...
    				$.ajax({
						...
						data:{del:del},
			  				success:function(data){
			  					if (data.flag) {
									parent.$.messager.alert("节点监控","节点监控处理成功",'info',
										function(r) {
											$('#dg').datagrid('reload');
 										});
  								} 
  ...
  <body class="easyui-layout">
	...
	<input type="hidden" name="method" value="outMonitor1">
