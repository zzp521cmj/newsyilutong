...
<script type="text/javascript">
	...
	var submitForm = function($dialog, $grid, $pjq, $mainMenu) {
			...
			$.ajax({
					type: "POST",
		  			...
		  			success:function(data){
		  				...
		  				type=data.ptype;
		  				if(type==1||type==2){
				 			$pjq.messager.alert('新增信息', '该车辆已经有车主', 'info');
						}else{
				 ...
				 $pjq.messager.alert('新增信息', '车主车牌号不可为空', 'info');
			}
		}else{
		...
		}else{$pjq.messager.alert('新增信息', '车主车牌号不可为空', 'info');}
		}
		} 
		  };
</script>
	...
	<form action="" method="post" id="Regform">
		...
		<fieldset>
			...
			<tr>
				...
				<tr>
					<td>出生日期:</td>
					<td class="td2"><input id="fxz"  class="Wdate "  readonly="readonly"  onfocus="WdatePicker({skin:'twoer'})"editable="false" name="birthday" /></td>
					<td>车牌号:</td>
				...
				<tr>
					...
					<td class="td2"><input id="fxz"type="text"
						name="address" /> <input type="hidden" name="" id="">
					</td>
				</tr>
				 <tr>
		...
		<fieldset>
			...
			<tr>
				...
				<tr>
					...
					<td>有效日期:</td>
					<td class="td2"><input  id="" class="Wdate " readonly="readonly" onfocus="WdatePicker({skin:'twoer'})"editable="false"
				...
				<tr>
					<td>记录:</td>
					<td class="td2" colspan="3"><input style="width:400px" class="easyui-textarea" type="text" name="drivingRecord" /></td>
				</tr>
			</table>
		</fieldset>
	</form>
