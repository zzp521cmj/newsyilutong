...
$("#pid").val(pid);
  ...
  <body class="easyui-layout">
    <form action="" method="post" id="Regform">
     <input type="hidden" name="shiping_order_id"  id="pid" >
	...
	<input type="hidden"   name=send_other >
 	...
 	<table class="tableclass">
					...
					<input type="radio" name="write_off2" value="1"  style="width:14px"/><label style="margin-left: 10px">现金</label>
					<input type="radio"  name="write_off2" value="0"  style="width:14px" /><label  style="margin-left: 10px">刷卡</label>
					</td> 
					</tr>
						<tr>
				<td style="color: blue;">备注:</td>
				<td colspan="3" class="td2"><textarea class="easyui-textarea" id="other_remarks1"
						cols="40" rows="2" name="other_remarks1"></textarea></td>
			</tr>			
					</table>
		  </form>	
  </body>
