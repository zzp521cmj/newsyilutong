	...
	$(function(){
		...
		$.ajax({
			...
			success : function(data) {
				if (data.printed == 1) {
					$("[name = printed]:checkbox").attr("checked", true);
				}
				if (data.printed == 0) {
					$("[name = printed]:checkbox").attr("checked", true);
				}
			...
			<table class="tableclasss">
				...
				<tr>
					...
					<td colspan="6" class="td6"><textarea cols="60" rows="2"
							type="text" name="fahuo_address" disabled="disabled"></textarea>
					</td>
					<td colspan="6"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2" class="td5"><input type="text"
						id="shouliwangdian" name="shouliwangdian" disabled="disabled" /></td>
					<td class="td3">制单人</td>
