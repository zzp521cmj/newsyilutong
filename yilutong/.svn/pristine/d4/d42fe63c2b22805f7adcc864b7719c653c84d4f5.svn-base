...
public interface OverbookingService {
	 ...
	 * 查询总条数
	 */
	public int getShipCheckInfoConun(String shiping_order_num,String shiping_accept_static,String custom_name,String receipt,User user);
	
	/*
	 *下单查询
	 */
	public List<Overbooking> getShipCheckInfo(int rows,int page,String shiping_order_num,String shiping_accept_static,String custom_name,String receipt,User user);
