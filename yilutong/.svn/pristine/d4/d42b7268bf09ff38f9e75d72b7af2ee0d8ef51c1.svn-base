  ...
  <body>
  	...
  	<table class="tableclass">
		...
		<td><font color="red" style="margin-right:10px">*</font>绑定线路</td>
		    ...
		    <td class="td2">
		    	<input type="hidden" style="width: 150px"  readonly="readonly" name="temporary_car_id" class="search-text"id="number_search"/>
		    </td>
		</tr>
	  	<tr>
	    ...
	    <tr>     	
		    ...
		    <td class="td2">
		    	<input  readonly="readonly" class=" validate[required,custom[number],min[1],max[999999]]"  name="price" style="width: 150px;text-align: right;"/>
		    </td>
		    <td><font color="red" style="margin-right:10px">*</font>发布人:</td>
			<td class="td2">
				 <input  readonly="readonly" class="validate[required]"  name="publisher" style="width: 150px" />
			</td>
		 </tr>
	   	<tr>
		    <td>货车类型:</td>
		    <td class="td2">
			 <select class="easyui-combobox"  readonly="readonly"  id='sect' name="truckTypeId" style="width:150px;" data-options="panelHeight : 'auto',editable:false">   
		    ...
		    <td class="td2" >
			 <input id="fxz"  readonly="readonly" class="validate[required,custom[number],min[1],max[9999]]" style="width: 150px" name="ranges" /><label style="margin-left: 2px">立方</label>
	      	</td>
		 </tr>
		<tr>     	
		    <td  ><font color="red" style="margin-right:10px">*</font>重量:</td>
		    <td class="td2">
		        <input readonly="readonly" class="validate[required,custom[number],min[1],max[9999]]" name="weight" style="width: 150px"><label style="margin-left: 4px">吨</label>
		    </td>
		    <td ><font color="red" style="margin-right:10px">*</font>车长:</td>
		    <td class="td2">
		    	<input  readonly="readonly" class="validate[required,custom[number],min[1],max[999]]" name="models" style="width: 150px"/><label style="margin-left: 4px">米</label>
		    </td>
		 </tr>
		<tr>  
		    <td><font color="red" style="margin-right:10px">*</font>联系方式:</td>
			<td class="td2">
		        <input readonly="readonly"  class="validate[custom[phone]]" style="width: 150px" name="contactInformation" />
		    </td>
		...
		<tr>
			...
			<td class="td2" colspan="3" style="height:60px">
				 <textarea class="validate[required]"  readonly="readonly" name="loadingAddress" style="width:414px;height:40px"></textarea>
			</td>
	    </tr>
	    <tr>
	    <td><font color="red" style="margin-right:10px">*</font>卸货地址:</td>
			<td class="td2" colspan="3" style="height:60px">
	      	<textarea  class="validate[required]" readonly="readonly" name="unloadingAddress" style="width:414px;height:40px"></textarea>
	      	</td>
	    </tr>
		<tr>
			<td>备注:</td>
		    <td class="td2" colspan="3" style="height:60px">
		        <textarea name="remarks"  readonly="readonly" style="width:414px;height:40px"></textarea>
		    </td>
		</tr>
		</table>
    </fieldset>
