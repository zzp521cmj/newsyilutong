...
public interface DriverCloseService {
    ...
    * 结算
    * */
   public int UdateDriverClose(String settlement_modes,String fee_remarks,String driver_close_naem,String driv_sige_name,String driv_card,String driv_bank,String oil_card,String oil_card_name,String[] id);
   /**
    * 提审
    * */
