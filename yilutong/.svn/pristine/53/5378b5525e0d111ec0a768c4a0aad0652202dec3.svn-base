...
<html>
  ...
  <script type="text/javascript">
		...
		var pid='<%=flg%>';
		$.ajax({
			url : 'payable.do?method=getUpdate4',
			data : {
				id : pid
			},
  ...
  <body class="easyui-layout">
   ...
   <input type="hidden"   name="direction" >
	...
	<input type="hidden"   name=unloading_fee1 >
 	<table class="tableclass">
			<tr>
				...
				<td colspan="3" class="td2"><textarea class="easyui-textarea" id="unloading_remarks"
						cols="40" rows="2" name="unloading_remarks"></textarea></td>
			</tr>		
			</table>
