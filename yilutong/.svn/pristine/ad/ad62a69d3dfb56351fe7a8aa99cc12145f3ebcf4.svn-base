 ...
 * 
 */
public interface PaiCheDanService {

	// 竞价查询
	List<Demand_release> getDemand_releaseInfo(int page, int rows,String zhuang,String xie,String models,String truckTypeId,String publisher,String determine);
	List<Demand_release> getDemand_releaseInfoPage(int page, int rows,String zhuang,String xie,String models,String truckTypeId,String publisher,String determine);
	List<Demand_release> getDemand_releaseInfoAll(String userid, String rownum, String rows);

	// 获取总行数
	int getCount(String zhuang,String xie,String models,String truckTypeId,String publisher,String determine);
	...
	ShippingOrder getPrintPCD(String checkarray);
}
