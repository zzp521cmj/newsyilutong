...
public class IOSPushMsgToSingleDevice {
	public static void IOSPushBatchMsg(String description,String channelIds) 
			throws PushClientException,PushServerException {
		// 1. get apiKey and secretKey from developer console
		PushKeyPair pair = new PushKeyPair(BaiduPushConstants.IOSAPIKEY, BaiduPushConstants.IOSSECRETKEY);
