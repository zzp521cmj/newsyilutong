...
public class AndroidPushBatchUniMsgNew {
	public static void androidPushBatchMsg(String msgtitle,String description,String[] channelIds,JSONObject jsonCustormCont)
			throws PushClientException,PushServerException {
		
		String apiKey = "uEL5064gxO4GmfmstUiNw7hC";
		String secretKey = "0gozev6GgtVGUyGgK8xALnb8S2ak56Y1";
		...
		try {
			...
			notification.put("notification_basic_style", 5);
