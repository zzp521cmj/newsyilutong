...
<html>
  ...
  <script type="text/javascript">
		...
		var pid='<%=flg%>';
		$.ajax({
			url : 'collect.do?method=getUpdate2',
			data : {
				id : pid
			},
  ...
  <body class="easyui-layout">
    <form action="" method="post" id="Regform">
  	<input type="hidden"   name="happen" value="paid">
	...
	<input type="hidden"   name="paid" >
 	<table class="tableclass">
			<tr>
					...
					<input type="radio" name="write_off5" value="1"  style="width:14px"/><label style="margin-left: 10px">现金</label>
					<input type="radio"  name="write_off5" value="0"  style="width:14px" /><label  style="margin-left: 10px">刷卡</label>
					</td> 
				</tr>
				<tr>
				<td style="color: blue;">备注:</td>
				<td colspan="3" class="td2"><textarea class="easyui-textarea" id="write_remarks"
						cols="40" rows="2" name="write_remarks"></textarea></td>
			</tr>			
			</table>
