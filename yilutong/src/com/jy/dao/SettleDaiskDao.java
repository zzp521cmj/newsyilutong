...
public interface SettleDaiskDao {
	//结算运费修改
	...
	//结算运费审核历史记录查询
		...
		//结算历史表修改查询
		List<Settle_history>	getupdateSettle(String table_name,Integer  settl_order,@Param("array")String[] idss);
		//结算历史表审核状态修改
		int 	updateSettle(@Param("list")List<Settle_history> list,String table_name,String settl_state);
}
