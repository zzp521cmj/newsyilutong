...
public  interface ReceiptBaobDao {
	int getReceiptBaob(String ddId, String city1,
			String start_date, String end_date,
			String start_date1, String end_date1, String pay_type, String fhname);//查询总数
	List<ShippingOrder> getReceiptBaobInfo(int rows,int page, String ddId, String city1,
			String start_date, String end_date,
	 ...
	 * */
	 public List<ShippingOrder> outReceiptBaob(String ddId, String city1,String start_date, String end_date,
				String start_date1, String end_date1, String pay_type, String fhname,@Param("array")String []checkarray);
	 //查询当天签收数量
