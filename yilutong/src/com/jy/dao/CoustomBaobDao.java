...
public  interface CoustomBaobDao {
	int getCoustomBaob(String ddId, String city1,
			String start_date, String end_date,
			String start_date1, String end_date1, String pay_type, String fhname);//查询总数
	List<ShippingOrder> getCoustomBaobInfo(int rows,int page, String ddId, String city1,
			String start_date, String end_date,
