...
public interface SettleDaiskService {
		//结算运费修改
	...
	//审核记录保存
		...
		//结算记录保存
				...
				//结算历史表修改查询
				List<Settle_history>	getupdateSettle(String table_name,Integer settl_order,String[] idss);
				//结算历史表审核状态修改
				int 	updateSettle(List<Settle_history> list,String table_name,String settl_state);
