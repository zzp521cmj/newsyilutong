...
public interface DistributionService {
	// 协议查询
	List<CreateAgreement> getCustomerSetYf(int rows, int page, String ddId,
	...
	int getCustomerSetYfs(String ddId, String types, String isdelivery,
			String start_date, String end_date, String start_date1,
			String end_date1, String start_date2, String end_date2,String sort,String order,String carname);
	...
	// 结算修改保存实收和差额
	int saveSettl_fu(List<CreateAgreement> llst);
	...
	// 审核记录保存
	int saveSettlyfSh(List<Delivery_Audit> list);
